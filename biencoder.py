...
def evaluate_model(args, is_inference=False):
	...
	if not is_inference:
		...
		eval_path = os.path.join(args.data_path, 'Evaluation_Datasets/{}/'.format('inference'))
		eval_data = load_inference_data(eval_path, args.split)
...
if __name__ == "__main__":
	...
	elif args.inference: evaluate_model(args, is_inference=True)
	#train model
